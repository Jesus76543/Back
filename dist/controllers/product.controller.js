...
export const updateProduct = async (req, res) => {
    ...
    try {
        ...
        // Actualizar producto
        const updatedProduct = await Producto.findByIdAndUpdate(productId, updateData, { new: true, runValidators: true });
        if (!updatedProduct) {
...
export const deleteProduct = async (req, res) => {
    ...
    try {
        ...
        const deletedProduct = await Producto.findByIdAndUpdate(productId, {
            status: false,
            deleteAt: new Date(),
...
export const updateProductStock = async (req, res) => {
    ...
    try {
        ...
        const updatedProduct = await Producto.findByIdAndUpdate(productId, { Quantity: newQuantity }, { new: true, runValidators: true });
        res.json({
